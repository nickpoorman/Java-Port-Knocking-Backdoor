...
public class Herbologist extends HoovervilleCharacter {

	public static final String TYPE = "Herbologist";
	...
	private final Skill mana = new Mana(150);
	private final Skill defense = new Defense(30);
	private final Skill intel = new Intelligence(120);
	private final Skill telepathy = new Telepathy(10);
	private final Skill dex = new Dexterity(50);
	private final Skill potion = new PotionMakingAbility(100);

	public Herbologist(String gender, String userName) {
