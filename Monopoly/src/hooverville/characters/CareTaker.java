...
public class CareTaker extends HoovervilleCharacter {

	public static final String TYPE = "Care Taker";
	...
	private final Skill mana = new Mana(70);
	...
	private final Skill dex = new Dexterity(150);
	private final Skill potion = new PotionMakingAbility(60);

	public CareTaker(String gender, String userName) {
