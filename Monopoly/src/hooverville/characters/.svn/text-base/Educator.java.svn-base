...
public class Educator extends HoovervilleCharacter {

	public static final String TYPE = "Educator";
	private final List<Item> sac = new ArrayList<Item>();

	private final Level level = new Level(1);

	private final Skill health = new Health(50);
	private final Skill mana = new Mana(10);
	private final Skill defense = new Defense(200);
	private final Skill intel = new Intelligence(200);
	private final Skill telepathy = new Telepathy(100);
	private final Skill dex = new Dexterity(30);
	private final Skill potion = new PotionMakingAbility(60);

	public Educator(String gender, String userName) {
