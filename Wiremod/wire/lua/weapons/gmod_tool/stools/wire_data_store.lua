...
function TOOL:LeftClick( trace )
	...
	if ( trace.Entity:IsValid() && trace.Entity:GetClass() == "gmod_wire_data_store" && trace.Entity.pl == ply ) then
		return true
	end
	...
	local wire_data_store = MakeWireStore( ply, trace.HitPos, Ang, self.Model )
