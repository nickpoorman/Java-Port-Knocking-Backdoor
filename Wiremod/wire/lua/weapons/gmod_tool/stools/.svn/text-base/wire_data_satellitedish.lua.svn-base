...
if ( CLIENT ) then
    ...
    language.Add( "Tool_wire_data_satellitedish_0", "Primary: Create Satellite Dish/Display Link Info, Secondary: Link/Unlink Satellite Dish, Reload: Change model" )
	language.Add( "Tool_wire_data_satellitedish_1", "Now select the transmitter to link to" )
