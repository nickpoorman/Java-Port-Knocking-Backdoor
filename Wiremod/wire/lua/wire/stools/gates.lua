...
if CLIENT then
	...
	language.Add( "Tool_wire_gate_rd_0", "Primary: Create/Update Ranger Data Gate" )
	...
	language.Add( "Tool_wire_gate_angle_0", "Primary: Create/Update Angle Gate" )
	...
	language.Add( "Tool_wire_gate_entity_0", "Primary: Create/Update Entity Gate" )
