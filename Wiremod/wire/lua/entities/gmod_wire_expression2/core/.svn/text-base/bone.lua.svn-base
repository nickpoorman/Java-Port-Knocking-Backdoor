...
--- Sets <value> as the <index>th element of <this>.
--- @nodoc
...
--- Removes the last element of <this> and returns it. Returns nobone() if it's not a '''bone'''.
--- @nodoc
...
--- Removes the <index>th element of <this> and returns it. Returns nobone() if it's not a '''bone'''.
--- @nodoc
...
--- Removes the first element of <this> and returns it. Returns nobone() if it's not a '''bone'''.
--- @nodoc
