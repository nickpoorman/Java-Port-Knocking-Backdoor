...
public class DataPacket extends TFTPPacket {
	...
	public DataPacket(DatagramPacket packet, int type){
		...
		System.out.println("Setting the payload length to: " + this.payloadLength);
		System.out.println("Packet data length: " + packet.getLength());
		...
		System.out.println("*** DONE Creating DataPacket ***");
	}
