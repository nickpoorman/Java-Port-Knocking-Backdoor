...
public class RatesPanel extends JPanel implements ActionListener {
    ...
    private void newRate() {
        ...
        nrp.setVisible(true);
        //insert a new rate for the given company and then get all again
...
//        for(String s : medicalData){
//            System.out.println("MEDDATA: " + s);
//        }
...
//        detailsButtons = new LinkedList<JButton>();
...
//        newLabel.setFont(newLabel.getFont().deriveFont((float) 16));
...
//            } else if (i == 1 || (i % (numFields + 1)) == 0) {
        ...
        //pos new label
//        layout.putConstraint(SpringLayout.EAST, newLabel, 5, SpringLayout.WEST, save);
//        layout.putConstraint(SpringLayout.SOUTH, newLabel, 0, SpringLayout.SOUTH, save);
...
class NewRatePanel extends JFrame implements ActionListener {
    ...
    private void save() {
        ...
        for (JTextField f : dataFields) {
            System.out.println("FIELD: " + f.getText());
