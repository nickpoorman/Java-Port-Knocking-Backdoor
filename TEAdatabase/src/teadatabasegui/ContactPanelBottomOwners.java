...
//            System.out.println("Sizeeeee: " + size);
    ...
    public void keyTyped(KeyEvent e) {
        //save automatically in background
        //int textFieldPointer = 0;
//        for (int i = 0; i < ownersTextFields.size(); i++) {
//        }
//        for (String s : ownerIDs) {
//            System.out.println("ownerids: " + s);
//        }
        //get owner/percent/id update
//        for (int i = 0; i < ownersTextFields.size(); i++) {
//            String ownerName = ownersTextFields.get(i).getText();
//            String percentOwnership = percentOwnershipTextFields.get(i).getText();
//            int ownerID = Integer.parseInt(ownerIDs.get(i));
//
//            TeaDatabase.updateCompanyOwners(ownerID, ownerName, percentOwnership);
//        }
    ...
    public void intiLayout() {
        ...
        for (int i = 0; i < ownersTextFields.size(); i++) {
            if (i == 0) {
                ...
                //  layout.putConstraint(SpringLayout.EAST, ownersTextFields.get(i), 0, SpringLayout.EAST, ownersTextFields.get(i - 1));
