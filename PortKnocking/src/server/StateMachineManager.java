...
public class StateMachineManager {
	...
	public KnockStateMachine addMachineIfNotExists(int sourceInt, byte[] sourceArray) throws UnknownHostException {
		if (!this.machines.containsKey(new Integer(sourceInt))) {
			KnockStateMachine tmpKSM = new KnockStateMachine(sourceArray);
