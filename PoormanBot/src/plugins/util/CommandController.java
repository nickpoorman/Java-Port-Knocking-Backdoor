...
public class CommandController {
	...
	//Im thinking about doing this a different way. 
	//Now that we are using regex we can just reference the Command based on the group number as in index in the array?
